...
<div class="space-y-10">
    ...
    {{-- ══════════════════════════════════════════════════
         FORM 1 — Información del Negocio
    ══════════════════════════════════════════════════ --}}
    <form method="POST" action="{{ route('business.profile.save') }}" enctype="multipart/form-data" class="space-y-0">
        @csrf
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    @if($business->logo_url)
                        <div class="mt-2 flex items-center gap-2">
                            <img src="{{ $business->logoPublicUrl() }}" alt="Logo" class="h-10 object-contain rounded border border-gray-200 p-0.5">
                            <span class="text-xs text-gray-400">Logo actual</span>
                        </div>
                    @endif
                    <p class="mt-1 text-xs text-gray-400">PNG o WebP · Recomendado 320×100 px</p>
                </div>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <input type="color" value="{{ old('primary_color', $business->primary_color ?? '#1a1a2e') }}"
                               ...
                               class="h-9 w-12 rounded border border-gray-300 cursor-pointer p-0.5 bg-white">
                        <input type="text" id="txt_primary" name="primary_color"
                               value="{{ old('primary_color', $business->primary_color ?? '#1a1a2e') }}"
                               oninput="this.previousElementSibling.value=this.value"
                               maxlength="7"
                               class="w-28 px-3 py-2 border border-gray-300 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">Texto principal de la tarjeta</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400">Labels y etiquetas de la tarjeta</p>
                </div>
