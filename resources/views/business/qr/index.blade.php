...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 text-center">
        ...
        <a
            href="{{ route('business.loyalty-program') }}"
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-8 text-center">
        ...
        <div class="flex justify-center mb-6">
            <div
                id="qrcode"
                class="p-4 bg-white border border-gray-200 rounded-xl inline-block shadow-sm"></div>
        </div>
    ...
    <div class="mt-6 bg-indigo-50 border border-indigo-100 rounded-xl p-5">
        ...
        <ol class="text-sm text-indigo-700 space-y-1 list-decimal list-inside">
            ...
            <li>
                Recibe automáticamente su tarjeta de lealtad digital
...
<script>
    ...
    const cardData = {
        ...
        logoUrl: @json(
            $business - > logoPublicUrl()
        ),

        primaryColor: @json(
            $business - > primary_color ?? '#1a1a2e'
        ),
        ...
        labelColor: @json(
            $business - > label_color ?? '#cccccc'
        ),

        appleWalletUrl: @json(
            asset('wallet/AddtoAppleWallet.webp')
        ),

        googleWalletUrl: @json(
            asset('wallet/AddtoGoogleWallet.webp')
        ),
                ...
                setTimeout(
                    () => {
                        ...
                        if (!canvas) {
                            ...
                            reject(
                                new Error(
                                    'No se pudo generar el QR en alta resolución.'
                                )
                            );
