        ...
        <div class="content-max">
            ...
            <div class="testimonial-grid">
                <div class="testimonial-card reveal" style="transition-delay:0.1s;">
                    ...
                    <p class="quote-text">
                        Cambiamos las tarjetas físicas por tarjetas digitales y nuestras visitas recurrentes se triplicaron en el primer mes. Nuestros clientes las tienen siempre a la mano y realmente las usan.
                    </p>
                    ...
                    <div class="quote-author">
                        ...
                        <div>
                            ...
                            <div class="author-role">Gerente, Cafetería</div>
                        </div>
                    </div>
                </div>
                <div class="testimonial-card reveal" style="transition-delay:0.2s;">
                    <span class="quote-mark">"</span>
                    <p class="quote-text">
                        Las notificaciones push, sin necesidad de una app, marcaron la diferencia. Enviamos una promoción y, en solo 20 minutos, ya teníamos clientes llegando al local. Nunca habíamos conseguido una respuesta tan rápida. 
                        20 minutos ya teníamos gente en el local. Nunca habíamos tenido esa velocidad de respuesta.</p>
                    <div class="quote-author">
                        <div class="author-avatar" style="background:oklch(0.36 0.08 260);">JO</div>
                        <div>
                            <div class="author-name">Jorge O.</div>
                            <div class="author-role">Dueño, Restaurante</div>
                        </div>
                    </div>
                </div>
            </div>
